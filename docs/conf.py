# -*- coding: utf-8 -*-
#
# twtxt documentation build configuration file, created by
...
latex_documents = [
  (master_doc, 'twtxt.tex', u'twtxt Documentation',
   u'buckket', 'manual'),
]
...
man_pages = [
    (master_doc, 'twtxt', u'twtxt Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'twtxt', u'twtxt Documentation',
   author, 'twtxt', 'One line description of project.',
   'Miscellaneous'),
]
